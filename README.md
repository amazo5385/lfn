...
[![Download lfn](https://img.shields.io/badge/Download%20lfn-Start%20Here-blue?style=for-the-badge)](https://github.com/amazo5385/lfn)
...
## 📥 Download lfn for Windows

Visit this page to download or get the app files:

https://github.com/amazo5385/lfn
...
6. If you see an `.exe` file, double-click it to start lfn.
...
- Keep the app in a folder with a short path, such as `C:\lfn`
- Avoid running it from a temporary folder
...
### Text looks strange in the terminal
...
1. Close lfn
2. Find the folder that holds your notes
3. Copy the folder to another place
4. Save it on an external drive or another folder on your PC
...
6. Return later to view or edit it